package com.minlia.cloud.stateful.code;


import com.minlia.cloud.stateful.localization.Constants.LanguageTypes;
import com.minlia.cloud.stateful.localization.Localize;
import com.minlia.cloud.stateful.localization.Localized;
...
public abstract class ApiCode {
   ...
   */
  @Localized(values = {
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "en_US", message = "UNKNOWN_EXCEPTION"),
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "zh_CN", message = "UNKNOWN_EXCEPTION"),
  })
  public static final int UNKNOWN_EXCEPTION = BASED_ON + 20000;
  /**
   * NULL_POINTER_EXCEPTION
   */
  @Localized(values = {
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "en_US", message = "NULL_POINTER_EXCEPTION"),
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "zh_CN", message = "NULL_POINTER_EXCEPTION"),
  })
  public static final int NULL_POINTER_EXCEPTION = BASED_ON + 20001;
  /**
   * FILE_NOT_FOUND_EXCEPTION
   */
  @Localized(values = {
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "en_US", message = "FILE_NOT_FOUND_EXCEPTION"),
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "zh_CN", message = "FILE_NOT_FOUND_EXCEPTION"),
  })
  public static final int FILE_NOT_FOUND_EXCEPTION = BASED_ON + 20002;
  /**
   * IO_EXCEPTION
   */
  @Localized(values = {
  ...
  public static final int IO_EXCEPTION = BASED_ON + 20003;
  /**
   * EXCEPTION
   */
  @Localized(values = {
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "en_US", message = "EXCEPTION"),
      @Localize(type = LanguageTypes.ExceptionsApiCode, locale = "zh_CN", message = "EXCEPTION"),
  })
  public static final int EXCEPTION = BASED_ON + 20004;
  /**
   * 未登录
   */
  @Localized(values = {
